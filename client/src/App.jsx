  ...
  function InfoCard() {
    return (
      <div className="infoCard">
        ...
        <p>in a nutshell, new stories are made midnight every day in a nodejs server using openai api, and the results are stores in firebase database. code is <a href="https://github.com/ruralad/openai-story-project" target="__blank">open source</a>  btw.</p>
      </div>
    );
  }
  return (
